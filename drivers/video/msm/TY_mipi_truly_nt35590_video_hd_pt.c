...
static int __init mipi_video_nt35590_wvga_pt_init(void)
{
	int ret;
	printk("%s : mipi_nt35590 enter\n",__func__);

	if (msm_fb_detect_client("mipi_video_nt35590_hd"))
		return 0;
	...
	pinfo.wait_cycle = 0;
	pinfo.bpp = 24;
	pinfo.lcdc.h_back_porch = 222;
	pinfo.lcdc.h_front_porch = 35;
...
module_init(mipi_video_nt35590_wvga_pt_init);
#endif
