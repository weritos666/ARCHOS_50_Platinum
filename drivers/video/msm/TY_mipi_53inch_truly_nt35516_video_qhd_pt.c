...
static int __init mipi_video_53inch_nt35516_wvga_pt_init(void)
{
	int ret;
	printk("%s : mipi_53inch_nt35516 enter\n",__func__);

	if (msm_fb_detect_client("mipi_video_53inch_nt35516_qhd"))
		return 0;
...
else //tydrv pengwei for tianma
{
	...
	pinfo.lcdc.h_front_porch = 105; //25
	pinfo.lcdc.h_pulse_width = 8;//8
	pinfo.lcdc.v_back_porch = 15; // 2
	pinfo.lcdc.v_front_porch = 20; // 4
	...
	ret = mipi_53inch_nt35516_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_53inch_nt35516_wvga_pt_init);
#endif
