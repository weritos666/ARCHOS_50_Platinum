...
extern int ov7695_Xshutdown;
extern int ov5648_pwdn;
extern int ov5648_reset;
...
#endif
/*Same to ov5648_truly_cm8352_csi_params*/
static struct msm_camera_csi_params ov7695_csi_params  = {
...
#if 0
static struct msm_sensor_exp_gain_info_t ov7695_exp_gain_info = {
...
int32_t ov7695_sensor_i2c_probe(struct i2c_client *client,
...
struct msm_camera_i2c_client *ov7695_i2c_client = &ov7695_sensor_i2c_client;
...
int32_t ov7695_sensor_setting(struct msm_sensor_ctrl_t *s_ctrl,
...
{
	int32_t rc = 0;
	uint16_t rdata0,rdata1;
	
	CDBG("%s IN\r\n", __func__);
	CDBG("%s, ov7695_Xshutdown:%d,ov5648_pwdn:%d,ov5648_reset:%d\r\n",
			__func__,ov7695_Xshutdown,ov5648_pwdn,ov5648_reset);

	/*ov5648 and ov7692 standby*/
	gpio_direction_output(ov7695_Xshutdown, 0);
	gpio_direction_output(ov5648_pwdn, 0);
	gpio_direction_output(ov5648_reset, 0);
	msleep(5);
	/*Apply DVDD and XCLK*/
	...
	/*Power up ov5648 and ov7692 */
	msleep(5);
	gpio_direction_output(ov5648_pwdn, 1);
	msleep(5);
	gpio_direction_output(ov5648_reset, 1);
	gpio_direction_output(ov7695_Xshutdown, 1);
	msleep(25);
	/*match sensor id*/
	msm_camera_i2c_read(ov5648_i2c_client, 0x300a, &rdata0,
		MSM_CAMERA_I2C_WORD_DATA);
	msm_camera_i2c_read(ov7695_i2c_client, 0x300a, &rdata1,
		MSM_CAMERA_I2C_WORD_DATA);
	
	CDBG("%s EXIT: ov5648 id = 0x%x,ov7695 id = 0x%x\r\n", __func__,rdata0,rdata1);
...
int32_t ov7692_sensor_write_exp_gain(struct msm_sensor_ctrl_t *s_ctrl,
...
static struct msm_sensor_fn_t ov7695_func_tbl = {
	...
	.sensor_csi_setting = ov7695_sensor_setting,
	...
	.sensor_write_exp_gain = ov7692_sensor_write_exp_gain,
	.sensor_write_snapshot_exp_gain = ov7692_sensor_write_exp_gain,
};
...
static struct msm_sensor_ctrl_t ov7695_s_ctrl = {
	...
	//.sensor_exp_gain_info = &ov7695_exp_gain_info,
