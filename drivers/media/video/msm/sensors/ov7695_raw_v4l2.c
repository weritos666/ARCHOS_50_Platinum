...
static struct msm_camera_i2c_reg_conf ov7695_raw_pip_init_settings_slave[] = {
	...
	{0x3a0f, 0x32}, // AEC in H {0x3a0f, 0x38}, yangzhe modify on 2013.01.06
	{0x3a10, 0x24}, // AEC in L {0x3a10, 0x30},
	{0x3a1b, 0x32}, // AEC out H {0x3a1b, 0x38},
	{0x3a1e, 0x24}, // AEC out L {0x3a1e, 0x30},
	{0x3a11, 0x70}, // control zone H
	{0x3a1f, 0x18}, // control zone L

	{0x3a18, 0x00}, // gain ceiling = 16x 
	{0x3a19, 0xa0}, // gain ceiling {0x3a19, 0xe0}, yangzhe modify on 2013.01.06
...
//wuchx 2013-1-6 modified for 5933b flip
#ifdef TYQ_CAMERA_OV7695_RAW_FLIP
	{0x0101, 0x01},
	{0x3811, 0x00},
	{0x3813, 0x05},
	{0x5000, 0x8d},//yangzhe add for 5933b lens
#else
	{0x0101, 0x02},
	{0x3811, 0x00},
	{0x3813, 0x05},
...
//	{0x3503, 0x30}, // AGC/AEC on
	...
	{0x3500,0x0},
//wuchx 2013-4-8 restore below settings,
// use 0x0101 standby instead.
//wuchx 2013-3-7 modified for ov7695 error with high-light begin
	{0x3502,0x40},
	{0x3501,0x21},
	{0x350b,0x12},
	//{0x3502,0x10},
	//{0x3501,0x00},
	//{0x350b,0x00},
//wuchx 2013-3-7 modified for ov7695 error with high-light end
	{0x350a,0x0},
	
//wuchx 2013-1-6 modified for 5933b flip
//#ifdef TYQ_CAMERA_OV7695_RAW_FLIP    yangzhe delete this setting and use default setting on 2013.03.26
//	{0x0347,0x00},
//	{0x034b,0xdf},
//#endif
