...
/*TY ShenLei 2013/03/25 for cdrom modify start*/
#ifdef TYQ_USB_CDROM_SUPPORT
	config->fsg.nluns = 3;
	...
	for (i = 0; i < config->fsg.nluns;i++){
		...
		/*
		 *cdrom deleted
		 *lun 0 - external storage
		 *lun 1 - internal storage
		 */ 
		config->fsg.luns[i].cdrom = 0;
	}
#endif /*TYQ_USB_CDROM_SUPPORT*/
	pr_err("ShenLei;config->fsg.nluns=%d",config->fsg.nluns);
/*TY ShenLei 2013/03/25 for cdrom end*/
