...
static struct clk_lookup msm_cmn_clk_7625a_7627a[] __initdata = {
	...
	CLK_LOOKUP("csi_vfe_clk",	csi0_vfe_clk.c,	"msm_camera_ov7695.0"),
	 /*tydrv qupw add for ov2675  */
#ifdef TYQ_CAMERA_OV2675_SUPPORT
   CLK_LOOKUP("csi_clk",		csi0_clk.c, "msm_camera_ov2675.0"),
   CLK_LOOKUP("csi_pclk",		csi0_p_clk.c,	"msm_camera_ov2675.0"),
   CLK_LOOKUP("csi_vfe_clk",	csi0_vfe_clk.c, "msm_camera_ov2675.0"),
#endif
	...
	CLK_LOOKUP("ebi2_clk",		ebi2_clk.c,	NULL),
	CLK_LOOKUP("ecodec_clk",	ecodec_clk.c,	NULL),
	/*TYRD wuxh modify for gpio 27 pwm backligth control  on 20121206*/
