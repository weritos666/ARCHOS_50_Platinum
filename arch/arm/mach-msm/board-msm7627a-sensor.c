...
//pengwei added for compass
#ifdef TYQ_COPMASS_MMC3416PJ
static struct i2c_board_info mmc3416_i2c_info[] __initdata = {
	{
...
//pengwei add compass
	...
	if (machine_is_msm8625q_skud()) {
		pr_info("i2c_register_board_info mmc346 ALP sensor!\n");
		i2c_register_board_info(MSM_GSBI1_QUP_I2C_BUS_ID,
					mmc3416_i2c_info,
					ARRAY_SIZE(mmc3416_i2c_info));
	}
#endif
