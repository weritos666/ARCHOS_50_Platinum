...
/*tydrv qupw add for ov2675 reset pin 11 */
#ifdef TYQ_CAMERA_OV2675_SUPPORT
#define GPIO_SKUD_CAM_2MP_REST 30
#endif
...
//wuchx undefine micro for deleting unless codes
#ifdef CONFIG_OV5647_TRULY_CM6868
#undef CONFIG_OV5647_TRULY_CM6868
#endif
...
#endif
#ifdef TYQ_CAMERA_OV5647_SUPPORT
//#ifdef CONFIG_OV5647_TRULY_CM6868
...
#endif
#ifdef TYQ_CAMERA_OV8830_SUPPORT
static struct msm_camera_gpio_conf gpio_conf_ov8830 = {
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
...
#ifdef TYQ_CAMERA_OV5648_SUPPORT
...
#if defined(CONFIG_WEBCAM_OV9726)|| defined(CONFIG_MT9E013)||defined(CONFIG_S5K4E1)
...
static struct camera_vreg_t ov5647_gpio_vreg_evbd[] = {
	{"ldo12", REG_LDO, 2700000, 3300000, 0},
	{"smps3", REG_LDO, 1800000, 1800000, 0},
	{"cam_ov5647_avdd", REG_GPIO, 0, 0, 0},
	{"cam_ov5647_vdd", REG_GPIO, 0, 0, 0},
...
#endif
#ifdef TYQ_CAMERA_OV8830_SUPPORT
static struct camera_vreg_t ov8830_gpio_vreg[] = {
	{"ldo12", REG_LDO, 2700000, 3300000, 0},
	{"smps3", REG_LDO, 1800000, 1800000, 0},
};
#endif
...
#ifdef TYQ_CAMERA_OV7695_SUPPORT
//#ifdef CONFIG_OV7695
//wuchx delete
#if 0
...
#ifdef TYQ_CAMERA_OV7695_RAW_SUPPORT
...
#endif
/*tydrv qupw add for ov2675  */
#ifdef TYQ_CAMERA_OV2675_SUPPORT
static struct msm_camera_gpio_conf skud_gpio_conf_ov2675 = {
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};

static struct camera_vreg_t ov2675_gpio_vreg[] = {
	{"ldo12", REG_LDO, 2700000, 3300000, 0},
	{"smps3", REG_LDO, 1800000, 1800000, 0},
};
static struct msm_camera_sensor_platform_info sensor_board_info_ov2675 = {
	...
	.cam_vreg = msm_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &skud_gpio_conf_ov2675,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov2675_data = {
	...
	.sensor_reset	   = GPIO_NOT_CONFIGURED,
	.sensor_pwd	     = GPIO_NOT_CONFIGURED,
	#ifdef TYQ_CAMERA_OV2675_REAR_SUPPORT
	.pdata			= &msm_camera_device_data_csi1[0],
	#else
	.pdata			= &msm_camera_device_data_csi0[0],
	#endif
...
#ifdef TYQ_CAMERA_OV5647_SUPPORT
//#ifdef CONFIG_OV5647_TRULY_CM6868
#ifdef TYQ_CAM_ACTUATOR_SUPPORTN
#else
...
#endif
#ifdef TYQ_CAMERA_OV8830_SUPPORT
static struct msm_actuator_info msm_act_main_cam_100_info = {
	.board_info     = &msm_act_main_cam_i2c_info,
	.cam_name   = MSM_ACTUATOR_MAIN_CAM_100,
	.bus_id         = MSM_GSBI0_QUP_I2C_BUS_ID,
	.vcm_pwd        = GPIO_NOT_CONFIGURED,
	.vcm_enable     = 0,
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_ov8830 = {
	...
	.cam_vreg = msm_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &gpio_conf_ov8830,
};

static struct msm_camera_sensor_flash_src msm_flash_src_ov8830 = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_LED1,
...
static struct msm_camera_sensor_flash_data flash_ov8830 = {
	...
	.flash_type             = MSM_CAMERA_FLASH_NONE,
#endif
	.flash_src              = &msm_flash_src_ov8830 ,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov8830_data = {
	...
	.camera_type	= BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &msm_act_main_cam_100_info,
};
#endif
...
//Add SKU7 specific settings
...
#endif
#ifdef TYQ_CAMERA_OV8830_SUPPORT
		sensor_board_info_ov8830.cam_vreg = ov8830_gpio_vreg;
		sensor_board_info_ov8830.num_vreg = ARRAY_SIZE(ov8830_gpio_vreg);
		msm_act_main_cam_100_info.vcm_pwd = GPIO_SKUD_CAM_5MP_CAM_VCM_PWDN;
		msm_act_main_cam_100_info.vcm_enable = 1;
		msm_camera_sensor_ov8830_data.sensor_reset=GPIO_SKUD_CAM_5MP_CAMIF_RESET;
		msm_camera_sensor_ov8830_data.sensor_pwd = GPIO_SKUD_CAM_5MP_SHDN_N;
		sensor_board_info_ov8830.mount_angle = 90;
		msm_flash_src_ov8830._fsrc.ext_driver_src.led_en = GPIO_SKUD_CAM_LED_EN;
		msm_flash_src_ov8830._fsrc.ext_driver_src.led_flash_en = GPIO_SKUD_CAM_LED_FLASH_EN;
#endif
	...
	{  
		...
		if(machine_is_msm8625q_evbd()) {
			printk("==machine_is_msm8625q_evbd==\n");
			sensor_board_info_ov5647_truly_cm6868.cam_vreg = ov5647_gpio_vreg_evbd;
			sensor_board_info_ov5647_truly_cm6868.num_vreg = ARRAY_SIZE(ov5647_gpio_vreg_evbd);
		} else {
			printk("!!machine_is_msm8625q_evbd!!\n");
			sensor_board_info_ov5647_truly_cm6868.cam_vreg = ov5647_truly_cm6868_gpio_vreg;
			sensor_board_info_ov5647_truly_cm6868.num_vreg = ARRAY_SIZE(ov5647_truly_cm6868_gpio_vreg);
		...
		#ifdef TYQ_CAM_ACTUATOR_SUPPORTN
		#else
		msm_act_main_cam_6_info.vcm_pwd = GPIO_SKUD_CAM_5MP_CAM_VCM_PWDN;
		msm_act_main_cam_6_info.vcm_enable = 1;
		#endif
		msm_camera_sensor_ov5647_truly_cm6868_data.sensor_reset=GPIO_SKUD_CAM_5MP_CAMIF_RESET;
		msm_camera_sensor_ov5647_truly_cm6868_data.sensor_pwd = GPIO_SKUD_CAM_5MP_SHDN_N;
		sensor_board_info_ov5647_truly_cm6868.mount_angle = 90;
		msm_flash_src_ov5647_truly_cm6868._fsrc.ext_driver_src.led_en = GPIO_SKUD_CAM_LED_EN;
		msm_flash_src_ov5647_truly_cm6868._fsrc.ext_driver_src.led_flash_en = GPIO_SKUD_CAM_LED_FLASH_EN;
#endif
...
//#ifdef CONFIG_OV7695
		...
		msm_camera_sensor_ov7695_data.sensor_pwd = GPIO_SKUD_CAM_1MP_PWDN;
		sensor_board_info_ov7695.gpio_conf = &skud_gpio_conf_ov7695;
		//wuchx 2012-11-29 modified begin
		sensor_board_info_ov7695.mount_angle = 270;
		//wuchx 2012-11-29 modified end
#endif
#ifdef TYQ_CAMERA_OV7695_RAW_SUPPORT
//#ifdef CONFIG_OV7695_RAW
...
/*tydrv qupw add for ov2675  */
#ifdef TYQ_CAMERA_OV2675_SUPPORT
        sensor_board_info_ov2675.cam_vreg = ov2675_gpio_vreg;
        sensor_board_info_ov2675.num_vreg = ARRAY_SIZE(ov2675_gpio_vreg);
        msm_camera_sensor_ov2675_data.vcm_pwd = 0;
        msm_camera_sensor_ov2675_data.vcm_enable = 0;
	#ifdef TYQ_CAMERA_OV2675_REAR_SUPPORT
	 msm_camera_sensor_ov2675_data.sensor_reset=GPIO_SKUD_CAM_5MP_CAMIF_RESET;
	 msm_camera_sensor_ov2675_data.sensor_pwd = GPIO_SKUD_CAM_5MP_SHDN_N;
	#else
	 msm_camera_sensor_ov2675_data.sensor_reset = GPIO_SKUD_CAM_2MP_REST;
        msm_camera_sensor_ov2675_data.sensor_pwd = GPIO_SKUD_CAM_1MP_PWDN;
	#endif
        sensor_board_info_ov2675.gpio_conf = &skud_gpio_conf_ov2675;
	#ifdef TYQ_CAMERA_OV2675_REAR_SUPPORT
        sensor_board_info_ov2675.mount_angle = 90;
	#else
        sensor_board_info_ov2675.mount_angle = 270;
	#endif
#endif
...
#ifdef TYQ_CAMERA_OV8830_SUPPORT
	{
		I2C_BOARD_INFO("ov8830", 0x20),//original
...
#endif
#ifdef TYQ_CAMERA_OV7695_RAW_SUPPORT
#ifdef  TYQ_FRONTAL_CAMERA_DYMANIC_REMOVE
#else
	{
...
#ifdef TYQ_CAMERA_OV5648_SUPPORT
	{
		I2C_BOARD_INFO("ov5648_truly_cm8352", 0x36 << 1),
...
static void skud_camera_gpio_cfg(void)
{
	...
	//ov5648/ov5647/ov2675_rear PWDN
	...
	if (rc < 0)
		pr_err("%s: unable to set gpio: %d direction for ov5648 camera\n",
			__func__, GPIO_SKUD_CAM_5MP_SHDN_N);
	//ov5648/ov5647/ov2675_rear RESET
	...
	#if defined(TYQ_CAMERA_OV7695_RAW_SUPPORT) ||defined(TYQ_CAMERA_OV7695_SUPPORT) 
	...
	// ================================
	//ov5648/ov5647/ov2675_rear VCM PWDN
	...
	rc = gpio_request(GPIO_SKUD_CAM_1MP_PWDN, "OV2675");

   if (rc < 0)
   pr_err("%s: gpio_request OV2675 sensor_pwdn: %d failed!",
   	__func__, GPIO_SKUD_CAM_1MP_PWDN);
   ...
   if (rc < 0)
	...
	rc = gpio_request(GPIO_SKUD_CAM_2MP_REST, "OV2675");

   if (rc < 0)
   pr_err("%s: gpio_request OV2675 sensor_reset: %d failed!",
   	__func__, GPIO_SKUD_CAM_2MP_REST);

   rc = gpio_tlmm_config(GPIO_CFG(
   	GPIO_SKUD_CAM_2MP_REST,
   	0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
   	GPIO_CFG_2MA), GPIO_CFG_ENABLE);
   
   if (rc < 0) {
   	pr_err("%s: unable to enable reset gpio for front camera!\n", __func__);
   	gpio_free(GPIO_SKUD_CAM_2MP_REST);
   }
   
   rc = gpio_direction_output(GPIO_SKUD_CAM_2MP_REST, 1);
   if (rc < 0)
   	pr_err("%s: unable to set gpio: %d direction for ov7695 camera\n",
   	__func__, GPIO_SKUD_CAM_1MP_PWDN);
